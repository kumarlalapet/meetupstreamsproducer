 ...
 */
public class RSVPEventsProducer {

    //api key 767a633f5a382a5f4247507d71126d32
    public static String topic = "/demostreams/meetups:rsvps";
    ...
    public static void main(String args[]) {
        ...
        httpClient.start();
        Observable<ObservableHttpResponse> response = ObservableHttp.createRequest(HttpAsyncMethods.createGet("https://stream.meetup.com/2/rsvps"), httpClient)
                .toObservable();
