 ...
 */
public class OpenEventsProducer {
    ...
    public static void main(String args[]) {
        ...
        httpClient.start();
        Observable<ObservableHttpResponse> response = ObservableHttp.createRequest(HttpAsyncMethods.createGet("https://stream.meetup.com/2/open_events"), httpClient)
                .toObservable();
